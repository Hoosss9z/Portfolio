...
export const profile: Profile = {
  ...
  tagline: "Développeur full‑stack motivé et adaptable. HTML, CSS, JavaScript, PHP, SQL, Python. Trilingue (arabe, français, anglais). Je conçois des solutions web utiles et orientées utilisateur.",
